...
# The error (name 'Legal_Entity' is not defined) at build time will depend on the value of the variables/flags --> build_a_physical_person or build_a_legal_entity
obj1 = Physical_Person('Johnn Doe', '1900-01-01')
print(obj1)

obj2 = Legal_Entity('dream factory inc', 'Dreams INC')
print(obj2)
